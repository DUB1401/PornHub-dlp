...
9. Если сервис недоступен в вашем регионе, обойти ограничение можно указав прокси через переменную среды **HTTPS_PROXY** (поддерживается также через файл _.env_).
